...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getAllProductsByCategory(
        ...
        ProductResponse productResponse= productService.getProductsByCategry(categoryId,pageNumber,pageSize,sortBy,sortOrder);
        return new ResponseEntity<>(productResponse,HttpStatus.OK);
    }

    @GetMapping("/public/categories/products//keyword/{keyword}")
